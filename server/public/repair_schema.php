...
try {
    ...
    $tables = [
        ...
        'task_reflections' => "CREATE TABLE IF NOT EXISTS task_reflections (id INT AUTO_INCREMENT PRIMARY KEY, task_id INT NOT NULL, user_id INT NOT NULL, transition_type ENUM('start_work', 'finish_task') DEFAULT 'start_work', content TEXT NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE CASCADE, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE)",
